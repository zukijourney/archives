...
import { Search, File, Folder, ArrowLeft, Moon, Sun, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gradient-to-br from-blue-100 to-purple-100 text-gray-900'} flex flex-col transition-colors duration-300`}>
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Link href="/" className={`flex items-center ${darkMode ? 'text-blue-400' : 'text-blue-600'} hover:underline mb-4`}>
